...
with tab1:
    ...
    if uploaded_file is not None:
        ...
        # Flattened out execution block to eliminate inner layout indentation issues
        process_receipt = st.button("🚀 Process & Extract Items", use_container_width=True)
        
        if process_receipt:
            st.info("Gemini is analyzing your receipt photo now... please wait.")
            ...
            try:
                ...
                st.error("Failed to convert image items into database format.")
...
with tab2:
    ...
    if not df_active.empty:
        ...
        st.error(f"An unexpected tracking error occurred:")
